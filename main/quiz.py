...
def randomize_word_for_quiz(
    ...
    selected_ids = pd.Series(unique_ids).sample(n=num_to_select)  
...
def generate_pinyin_and_meaning_quiz(
    ...
    '''
    This function generates a quiz for pinyin and meaning.  
    The quiz is generated by selecting a random set of words from the dictionary.  
    The quiz is returned as a DataFrame
    '''
    quiz_id = randomize_word_for_quiz(dict_df, id_column=id_column, **random_params).values
    ...
    return (quiz_df, quiz_answer_key)
